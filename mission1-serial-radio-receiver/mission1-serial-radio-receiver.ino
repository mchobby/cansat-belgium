// Cansat-Belgium - Mission 1 - Radio Receiver 
//
// RFM69HCW Receiver --to--> Serial connexion
//
// Send the following data to the serial connexion:
//   [DATA](len=38,RSSI=-60):15853|7778505|22.96|98842.41|21.92;
//   [DATA](len=<len_of_transmitted_data>,RSSI=<radio_quality_level>)<transmitted_data>
//  
// Based on RadioHead69_RawDemo_RX 
//
// -*- mode: C++ -*-
